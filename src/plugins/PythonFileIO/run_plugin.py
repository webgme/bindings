"""
This script is called by the plugin-wrapper, PythonFileIO.js, which passes down the
...
from PythonFileIO import PythonFileIO
...
plugin = PythonFileIO(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
