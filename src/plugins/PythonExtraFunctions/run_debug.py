...
from PythonExtraFunctions import PythonExtraFunctions
...
node_process = subprocess.Popen(['node', COREZMQ_SERVER_FILE, PROJECT_NAME, '-i', 'PythonExtraFunctions', '-p', PORT, '-m', METADATA_PATH],
